...
#define FIREBASE_URL "https://led-control-56a68-default-rtdb.asia-southeast1.firebasedatabase.app/led_control.json"

static const char *TAG = "LED_FIREBASE";
...
// ================= FIREBASE =================
void get_led_state_from_firebase() {
...
void app_main(void) {
    ...
    while (1) {
        ...
        // 🔥 Read Firebase and control LED
        get_led_state_from_firebase();
