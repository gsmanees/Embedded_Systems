...
// i2c clock disable macro

#define I2C1_DIS()   (RCC->APB1ENR &= ~(1U << 21))
#define I2C2_DIS()   (RCC->APB1ENR &= ~(1U << 22))
#define I2C3_DIS()   (RCC->APB1ENR &= ~(1U << 23))


// spi clock disable macro
#define SPI1_DIS()   (RCC->APB2ENR &= ~(1U << 12))
#define SPI2_DIS()   (RCC->APB1ENR &= ~(1U << 14))
#define SPI3_DIS()   (RCC->APB1ENR &= ~(1U << 15))
#define SPI4_DIS()   (RCC->APB2ENR &= ~(1U << 13))


// usart clock disable macro
#define USART1_DIS() (RCC->APB2ENR &= ~(1U << 4))
#define USART2_DIS() (RCC->APB1ENR &= ~(1U << 17))
#define USART3_DIS() (RCC->APB1ENR &= ~(1U << 18))
#define USART4_DIS() (RCC->APB1ENR &= ~(1U << 19))
#define USART5_DIS() (RCC->APB1ENR &= ~(1U << 20))
#define USART6_DIS() (RCC->APB2ENR &= ~(1U << 4))


// can clock disable macros

#define CAN1_DIS()   (RCC->APB1ENR &= ~(1U << 25))
#define CAN2_DIS()   (RCC->APB1ENR &= ~(1U << 26))
